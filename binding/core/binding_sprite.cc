...
MRB_FUNC(Sprite_initialize) {
  ...
  lime::RefPtr<lime::Sprite> obj = nullptr;
  EXC_BEGIN {
    obj = lime::MakeRefCounted<lime::Sprite>(viewport);
  }
  EXC_END(mrb);
...
BINDING_ATTR_OBJECT_REF(Sprite,
                        ...
                        lime::Rect,
                        kRectDataType);
BINDING_ATTR_INT(Sprite, lime::Sprite, X);
BINDING_ATTR_INT(Sprite, lime::Sprite, Y);
BINDING_ATTR_INT(Sprite, lime::Sprite, OX);
BINDING_ATTR_INT(Sprite, lime::Sprite, OY);
BINDING_ATTR_FLOAT(Sprite, lime::Sprite, ZoomX);
BINDING_ATTR_FLOAT(Sprite, lime::Sprite, ZoomY);
BINDING_ATTR_FLOAT(Sprite, lime::Sprite, Angle);
BINDING_ATTR_INT(Sprite, lime::Sprite, WaveAmp);
BINDING_ATTR_INT(Sprite, lime::Sprite, WaveLength);
BINDING_ATTR_INT(Sprite, lime::Sprite, WaveSpeed);
BINDING_ATTR_FLOAT(Sprite, lime::Sprite, WavePhase);
BINDING_ATTR_BOOL(Sprite, lime::Sprite, Mirror);
BINDING_ATTR_INT(Sprite, lime::Sprite, BushDepth);
BINDING_ATTR_INT(Sprite, lime::Sprite, BushOpacity);
BINDING_ATTR_INT(Sprite, lime::Sprite, Opacity);
BINDING_ATTR_INT(Sprite, lime::Sprite, BlendType);
BINDING_ATTR_OBJECT_REF(Sprite,
                        lime::Sprite,
                        Color,
                        lime::Color,
                        kColorDataType);
BINDING_ATTR_OBJECT_REF(Sprite, lime::Sprite, Tone, lime::Tone, kToneDataType);
BINDING_ATTR_OBJECT_REF(Sprite,
                        lime::Sprite,
                        Effect,
                        lime::Effect,
...
BINDING_INHERITED_DISPOABLE(Sprite, lime::Sprite);
BINDING_ATTR_OBJECT_REF(Sprite,
                        lime::Sprite,
                        Viewport,
                        lime::Viewport,
                        kViewportDataType);
BINDING_ATTR_BOOL(Sprite, lime::Sprite, Visible);
BINDING_ATTR_INT(Sprite, lime::Sprite, Z);

void InitSpriteBinding(mrb_state* mrb) {
  auto klass = DefineClass(mrb, "Sprite");

  mrb_define_method(mrb, klass, "initialize", Sprite_initialize,
                    MRB_ARGS_ANY());
  ...
  mrb_define_method(mrb, klass, "src_rect=", Sprite_SrcRectEqual,
                    MRB_ARGS_REQ(1));
  ...
  mrb_define_method(mrb, klass, "wave_amp=", Sprite_WaveAmpEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "wave_length", Sprite_WaveLength,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "wave_length=", Sprite_WaveLengthEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "wave_speed", Sprite_WaveSpeed,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "wave_speed=", Sprite_WaveSpeedEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "wave_phase", Sprite_WavePhase,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "wave_phase=", Sprite_WavePhaseEqual,
                    MRB_ARGS_REQ(1));
  ...
  mrb_define_method(mrb, klass, "bush_depth", Sprite_BushDepth,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "bush_depth=", Sprite_BushDepthEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "bush_opacity", Sprite_BushOpacity,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "bush_opacity=", Sprite_BushOpacityEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "opacity", Sprite_Opacity, MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "opacity=", Sprite_OpacityEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "blend_type", Sprite_BlendType,
                    MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "blend_type=", Sprite_BlendTypeEqual,
                    MRB_ARGS_REQ(1));
  ...
  mrb_define_method(mrb, klass, "effect", Sprite_Effect, MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "effect=", Sprite_EffectEqual,
                    MRB_ARGS_REQ(1));
  // Inherited from Dispoable
  mrb_define_method(mrb, klass, "dispose", Sprite_Dispose, MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "disposed?", Sprite_IsDisposed,
                    MRB_ARGS_NONE());
  // Inherited from ViewportChild / Drawable
  mrb_define_method(mrb, klass, "viewport", Sprite_Viewport, MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "viewport=", Sprite_ViewportEqual,
                    MRB_ARGS_REQ(1));
  mrb_define_method(mrb, klass, "visible", Sprite_Visible, MRB_ARGS_NONE());
  mrb_define_method(mrb, klass, "visible=", Sprite_VisibleEqual,
                    MRB_ARGS_REQ(1));
